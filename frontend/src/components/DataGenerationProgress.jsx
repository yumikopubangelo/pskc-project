...
export default function DataGenerationProgress({ onComplete, useWebSocket = true }) {
    ...
    <div className="w-full bg-white rounded-lg shadow-lg p-6 border border-blue-200">
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-lg font-bold text-blue-600">{progress.percent.toFixed(1)}%</span>
        </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-blue-50 p-4 rounded-lg">
          ...
          <div className="text-xl font-bold text-blue-600">
            {progress.events_per_second.toFixed(0)}
          </div>
